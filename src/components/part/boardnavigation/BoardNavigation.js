...
const BoardNavigation = ({ resData, ph, searchInputValue }) => {
  ...
  const getSearchBoardList = async (data, curnav) => {
    ...
    const url = "http://localhost:8888/board/search";
    const obj = {
      method: "POST",
  ...
  const getBoardByNav = async (curnav) => {
    ...
    const url = "http://localhost:8888/board/board?page=" + curnav;
    const obj = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getBoardByArrow = async (pageValue) => {
    const url = "http://localhost:8888/board/board?page=" + pageValue;
    const obj = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
